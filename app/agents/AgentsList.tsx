    ...
    return (
      <div style={{ textAlign: "center", padding: "48px 24px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <Link href="/agents/new" style={{ display: "block", padding: "12px", borderRadius: 10, border: "1px solid rgba(255, 255, 255, 0.09)", background: "transparent", color: "#9096a8", fontSize: 14, textDecoration: "none" }}>
            自分で作成する
          </Link>
        </div>
      </div>
