            ...
            <div style={{ padding: "20px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    ...
                    <div style={{ display: "flex", gap: 6, flexWrap: "wrap", justifyContent: "flex-end" }}>
                      {parsed.connections.map((c, i) => (
                        <span key={i} style={{
                          fontSize: 11, color: "#6c71e8",
                          background: "#1e2044", padding: "3px 9px",
                ...
                <div style={{ borderTop: "1px solid #22252f", paddingTop: 12 }}>
                  ...
                  <p style={{ fontSize: 12, color: "#6a7080", lineHeight: 1.65, margin: 0 }}>
                    {parsed.prompt}
                  </p>
                </div>
              </div>
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  color: "#4a5060", fontSize: 13, cursor: "pointer",
                  fontFamily: "inherit",
                }}
              >
                やり直す
