...
function renderMarkdown(text: string) {
  return text
    ...
    .replace(/^---$/gm, '<hr style="border:none;border-top:1px solid #2e3440;margin:16px 0"/>')
      ...
      <div className="page">
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              {pastItems.length > 0 && (
                <span style={{ fontSize: 12, color: "#4a5060", background: "transparent", border: "1px solid #2e3440", padding: "2px 8px", borderRadius: 4, fontWeight: 500 }}>
                  {pastItems.length}件
                </span>
              )}
        ...
        {/* サマリーセクション */}
        <div style={{ marginTop: 24, background: "#1c2028", border: "1px solid #2e3440", borderRadius: 12, padding: "18px 20px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
            ...
            <div style={{ textAlign: "center", borderLeft: "1px solid #2e3440", borderRight: "1px solid #2e3440" }}>
              <p style={{ fontSize: 22, fontWeight: 700, color: "#e8eaf0", margin: "0 0 4px", letterSpacing: "-0.02em" }}>
      ...
      <div className="page">
        ...
        {groups.length === 0 ? (
          <div className="card" style={{ textAlign: "center", padding: 28 }}>
            ...
            <Link href="/agents/" prefetch={false} style={{ color: "#6c71e8", fontSize: 13, textDecoration: "none" }}>
              エージェントを実行する
            </Link>
          </div>
        ) : (
