...
function renderMarkdown(text: string) {
  return text
    ...
    .replace(/^---$/gm, '<hr style="border:none;border-top:1px solid #27272a;margin:16px 0"/>')
      ...
      <div className="page">
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              {pastItems.length > 0 && (
                <span style={{ fontSize: 12, color: "#4a5060", background: "transparent", border: "1px solid #27272a", padding: "2px 8px", borderRadius: 4, fontWeight: 500 }}>
                  {pastItems.length}件
                </span>
              )}
        ...
        {/* サマリーセクション */}
        <div style={{ marginTop: 24, background: "#18181b", border: "1px solid #27272a", borderRadius: 12, padding: "18px 20px" }}>
