  ...
  return (
    <div style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 24px" }}>
      ...
      <div style={{ width: "100%", maxWidth: 340, display: "flex", flexDirection: "column", gap: 12 }}>
        {/* Apple Sign In - must be first/prominent for App Store compliance */}
        <button
          onClick={() => signIn("apple", { callbackUrl: "/home" })}
          style={{
            width: "100%", padding: "14px 20px", borderRadius: 10,
            border: "1px solid #3a3a3c", background: "#fff", color: "#000",
        ...
        <button
          ...
          style={{
            width: "100%", padding: "14px 20px", borderRadius: 10,
            border: "1px solid #2e3440", background: "#1c2028", color: "#e8eaf0",
            fontSize: 15, fontWeight: 500, cursor: "pointer",
            display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontFamily: "inherit",
          }}
        >
