...
function renderMarkdown(text: string) {
  return text
    ...
    .replace(/^## (\d+)\. (.+)$/gm, '<h2 style="font-size:15px;font-weight:600;color:#e8eaf0;margin:18px 0 6px;padding-top:12px;border-top:1px solid rgba(255, 255, 255, 0.13)"><span style="color:#6c71e8;margin-right:6px">$1.</span>$2</h2>')
    ...
    .replace(/^---$/gm, '<hr style="border:none;border-top:1px solid rgba(255, 255, 255, 0.13);margin:14px 0"/>')
