...
const TEMPLATES = [
  {
    ...
    description: "Track when competitors are mentioned online and get daily summaries.",
  ...
  },
  {
    ...
    description: "Compile your week's activity into a structured report automatically.",
  ...
  },
  {
    ...
    description: "When a new inquiry arrives, draft a personalized response immediately.",
  ...
  },
  {
    ...
    description: "Monitor product prices and notify you when targets are reached.",
    trigger: "Every hour",
    category: "E-commerce",
  },
  {
    ...
    description: "Summarize trending discussions in your industry each morning.",
  ...
  },
  {
    ...
    description: "Analyze incoming contracts and flag unusual clauses for review.",
    ...
    <main style={{ background: "#0a0a0a", minHeight: "100vh", color: "#ffffff" }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          Describe what you want automated in plain language.
          Lattice builds and runs the agent for you.
        </p>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#333" }}></div>
            <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#333" }}></div>
            <span style={{ marginLeft: 8, fontSize: 12, color: "#444444", fontFamily: "monospace" }}>
              lattice.run / new-agent
            </span>
          </div>
          <div style={{ padding: "28px 24px" }}>
            <p style={{ fontSize: 12, color: "#444444", marginBottom: 12, letterSpacing: "0.05em", textTransform: "uppercase" }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 12, color: "#444444", marginBottom: 10, letterSpacing: "0.05em", textTransform: "uppercase" }}>
                Agent created
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {[
                  ...
                  <div key={item.label} style={{ display: "flex", justifyContent: "space-between", fontSize: 13 }}>
                    ...
                    <span style={{ color: item.label === "Status" ? "#22c55e" : "#888888" }}>{item.value}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="how-it-works" style={{
        ...
        <div style={{ marginBottom: 64 }}>
          <p style={{ fontSize: 12, color: "#444444", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 16 }}>
            How it works
          </p>
          <h2 style={{
          ...
          {[
            {
              ...
              description: "Write what you want to automate as if explaining to a colleague. No technical terminology needed.",
            },
            {
              step: "02",
              title: "Lattice builds the agent",
              description: "The system translates your description into a working automation with the right schedule, logic, and connections.",
            },
            {
              step: "03",
              title: "It runs while you work",
              description: "Your agent operates in the background on schedule. You get results, not process.",
            },
          ].map((item) => (
      ...
      <section style={{
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
            ...
            <Link href="/agents" style={{ fontSize: 13, color: "#888888", textDecoration: "none" }}>
              View all →
            </Link>
          </div>
        </div>
          ...
          {TEMPLATES.map((template) => (
            <Link key={template.id} href="/agents/new" style={{ textDecoration: "none" }}>
              ...
              >
                ...
                <p style={{ fontSize: 13, color: "#666666", lineHeight: 1.6, marginBottom: 16 }}>
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Stop doing work<br />
          <span style={{ color: "#444444" }}>that can run itself.</span>
        </h2>
        <p style={{ fontSize: 16, color: "#666666", marginBottom: 40 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 24 }}>
            {["Privacy", "Terms"].map(item => (
              <Link key={item} href={`/${item.toLowerCase()}`} style={{ fontSize: 13, color: "#444444", textDecoration: "none" }}>
                {item}
              </Link>
            ))}
          </div>
