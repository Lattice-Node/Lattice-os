...
export default function SettingsClient({ name, email, image, credits }: Props) {
  ...
  if (showCredit) {
    return (
      <main style={{ minHeight: "100vh", backgroundColor: "#000000", color: "#e8eaf0", paddingBottom: 100 }}>
            ...
            {CREDIT_PLANS.map((plan) => (
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${plan.popular ? "#6c71e8" : "rgba(255, 255, 255, 0.08)"}`,
                  borderRadius: 12,
                  padding: "20px",
                  position: "relative",
                }}
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    border: "none",
                    background: plan.popular ? "#6c71e8" : "rgba(255, 255, 255, 0.04)",
  ...
  return (
    <main style={{ minHeight: "100vh", backgroundColor: "#000000", color: "#e8eaf0", paddingBottom: 100 }}>
      <div style={{ maxWidth: 420, margin: "0 auto", padding: "48px 20px 24px" }}>
        ...
        {/* アカウント */}
        <div style={{ background: "#0a0b0e", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: 12, padding: "20px", marginBottom: 12 }}>
          <p style={{ fontSize: 11, color: "#6a7080", letterSpacing: "0.06em", textTransform: "uppercase", margin: "0 0 14px" }}>アカウント</p>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            {image ? (
              <img src={image} alt={name} width={44} height={44} style={{ borderRadius: "50%", border: "1px solid rgba(255, 255, 255, 0.08)" }} />
            ) : (
        ...
        <div style={{ background: "#0a0b0e", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: 12, padding: "20px", marginBottom: 12 }}>
          ...
          {connections.length > 0 && (
            <div style={{ marginBottom: 14, display: "flex", flexDirection: "column", gap: 8 }}>
              {connections.map(c => {
                ...
                return (
                  <div key={c.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "#000000", borderRadius: 8, padding: "10px 14px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {!connections.find(c => c.provider === "gmail") && (
              <a href="/api/connections/gmail" style={{ display: "flex", alignItems: "center", gap: 10, padding: "11px 14px", borderRadius: 8, border: "1px solid rgba(255, 255, 255, 0.08)", textDecoration: "none", cursor: "pointer" }}>
            ...
            {!connections.find(c => c.provider === "discord") && (
              <a href="/api/connections/discord" style={{ display: "flex", alignItems: "center", gap: 10, padding: "11px 14px", borderRadius: 8, border: "1px solid rgba(255, 255, 255, 0.08)", textDecoration: "none", cursor: "pointer" }}>
        ...
        {/* リンク */}
        <div style={{ background: "#0a0b0e", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: 12, overflow: "hidden", marginBottom: 12 }}>
          <a href="/privacy" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 20px", borderBottom: "1px solid rgba(255, 255, 255, 0.08)", textDecoration: "none" }}>
        ...
        <button
          ...
          style={{ width: "100%", padding: "13px", borderRadius: 10, border: "1px solid rgba(255, 255, 255, 0.08)", background: "transparent", color: "#f87171", fontSize: 14, fontWeight: 500, cursor: "pointer", fontFamily: "inherit", marginBottom: 10 }}
        >
          ログアウト
        </button>
