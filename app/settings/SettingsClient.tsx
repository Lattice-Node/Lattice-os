              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    border: "none",
                    background: plan.popular ? "#6c71e8" : "rgba(255, 255, 255, 0.08)",
      ...
      <div style={{ maxWidth: 420, margin: "0 auto", padding: "48px 20px 24px" }}>
        ...
        <div style={{ background: "#0a0b0e", border: "1px solid rgba(255, 255, 255, 0.15)", borderRadius: 12, padding: "20px", marginBottom: 12 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            {image ? (
              <img src={image} alt={name} width={44} height={44} style={{ borderRadius: "50%", border: "1px solid rgba(255, 255, 255, 0.15)" }} />
            ) : (
        ...
        <div style={{ background: "#0a0b0e", border: "1px solid rgba(255, 255, 255, 0.15)", borderRadius: 12, padding: "20px", marginBottom: 12 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {!connections.find(c => c.provider === "gmail") && (
              <a href="/api/connections/gmail" style={{ display: "flex", alignItems: "center", gap: 10, padding: "11px 14px", borderRadius: 8, border: "1px solid rgba(255, 255, 255, 0.15)", textDecoration: "none", cursor: "pointer" }}>
            ...
            {!connections.find(c => c.provider === "discord") && (
              <a href="/api/connections/discord" style={{ display: "flex", alignItems: "center", gap: 10, padding: "11px 14px", borderRadius: 8, border: "1px solid rgba(255, 255, 255, 0.15)", textDecoration: "none", cursor: "pointer" }}>
        ...
        <button
          ...
          style={{ width: "100%", padding: "13px", borderRadius: 10, border: "1px solid rgba(255, 255, 255, 0.15)", background: "transparent", color: "#f87171", fontSize: 14, fontWeight: 500, cursor: "pointer", fontFamily: "inherit", marginBottom: 10 }}
        >
          ログアウト
        </button>
