  ...
  if (selected) {
    return (
      <div style={{ maxWidth: 420, margin: "0 auto", padding: "0 0 100px" }}>
        ...
        {/* 説明 */}
        <div style={{ background: "#141416", border: "1px solid rgba(255, 255, 255, 0.09)", borderRadius: 12, padding: "18px 20px", marginBottom: 12 }}>
        ...
        {/* 詳細情報 */}
        <div style={{ background: "#141416", border: "1px solid rgba(255, 255, 255, 0.09)", borderRadius: 12, overflow: "hidden", marginBottom: 24 }}>
