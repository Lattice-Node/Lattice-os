...
const tabs = [
  ...
  { href: "/agents/new/", label: "作成", icon: (a: boolean) => <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={a ? "var(--nav-active)" : "var(--nav-inactive)"} strokeWidth="2"><path d="M12 5v14M5 12h14"/></svg> },
